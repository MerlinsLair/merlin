...
rpc_timeout = '10s'
account_prefix = 'mer'
key_name = 'val01-merlin-a'
store_prefix = 'ibc'
max_gas = 6000000
gas_price = { price = 0.000, denom = 'umer' }
gas_adjustment = 1.0
...
# import keys
hermes keys restore ${OSMO_B_E2E_CHAIN_ID} -n "val01-merlin-b" -m "${OSMO_B_E2E_VAL_MNEMONIC}"
hermes keys restore ${OSMO_A_E2E_CHAIN_ID} -n "val01-merlin-a" -m "${OSMO_A_E2E_VAL_MNEMONIC}"
