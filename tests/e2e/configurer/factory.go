...
import (
	...
	"github.com/merlinslair/merlin/tests/e2e/containers"
...
// Git branch version of Merlin codebase.
...
func New(t *testing.T, isIBCEnabled, isDebugLogEnabled bool, upgradeSettings UpgradeSettings) (Configurer, error) {
	...
	if isIBCEnabled && upgradeSettings.IsEnabled {
		...
		// to utilize the older version of merlin to upgrade from
