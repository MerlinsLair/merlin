...
func CustomQuerier(qp *QueryPlugin) func(ctx sdk.Context, request json.RawMessage) ([]byte, error) {
	return func(ctx sdk.Context, request json.RawMessage) ([]byte, error) {
		var contractQuery bindings.MerlinQuery
		if err := json.Unmarshal(request, &contractQuery); err != nil {
			return nil, sdkerrors.Wrap(err, "merlin query")
		}
		...
		case contractQuery.FullDenom != nil:
			...
			if err != nil {
				return nil, sdkerrors.Wrap(err, "mer full denom query")
			}
			...
			if err != nil {
				return nil, sdkerrors.Wrap(err, "mer full denom query response")
			}
		...
		default:
			return nil, wasmvmtypes.UnsupportedRequest{Kind: "unknown merlin query variant"}
		}
	}
}
