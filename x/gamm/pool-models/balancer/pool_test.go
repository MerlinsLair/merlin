...
import (
	...
	"github.com/merlinslair/merlin/x/gamm/pool-models/internal/test_helpers"
...
func TestUpdateIntermediaryPoolAssetsLiquidity(t *testing.T) {
	const (
		umerValueOriginal = 1_000_000_000_000
	...
	testCases := []struct {
	...
	}{
		{
			...
			newLiquidity: sdk.NewCoins(
				sdk.NewInt64Coin("umer", 1_000),
				sdk.NewInt64Coin("atom", 2_000),
				sdk.NewInt64Coin("ion", 3_000)),
			poolAssets: map[string]balancer.PoolAsset{
				"umer": {
					Token:  sdk.NewInt64Coin("umer", umerValueOriginal),
...
func TestCalcJoinSingleAssetTokensIn(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			swapFee:      sdk.MustNewDecFromStr("0"),
			poolAssets:   oneTrillionEvenPoolAssets,
			tokensIn:     sdk.NewCoins(sdk.NewInt64Coin("umer", 50_000), sdk.NewInt64Coin("uatom", 50_000)),
		...
		},
		{
			...
			poolAssets: []balancer.PoolAsset{
				{
					Token:  sdk.NewInt64Coin("umer", 2_000_000_000),
			...
			tokensIn:     sdk.NewCoins(sdk.NewInt64Coin("umer", 50_000), sdk.NewInt64Coin("uatom", 100_000)),
		...
		},
		{
			...
			tokensIn:     sdk.NewCoins(sdk.NewInt64Coin("umer", 50_000), sdk.NewInt64Coin(doesNotExistDenom, 50_000)),
