...
// source: merlin/gamm/v2/query.proto
...
import (
	...
	_ "github.com/merlinslair/merlin/x/gamm/types"
...
func init() {
	proto.RegisterType((*QuerySpotPriceRequest)(nil), "merlin.gamm.v2.QuerySpotPriceRequest")
	proto.RegisterType((*QuerySpotPriceResponse)(nil), "merlin.gamm.v2.QuerySpotPriceResponse")
}

func init() { proto.RegisterFile("merlin/gamm/v2/query.proto", fileDescriptor_49ff000e88fc374c) }
...
func (c *queryClient) SpotPrice(ctx context.Context, in *QuerySpotPriceRequest, opts ...grpc.CallOption) (*QuerySpotPriceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlin.gamm.v2.Query/SpotPrice", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_SpotPrice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlin.gamm.v2.Query/SpotPrice",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "merlin.gamm.v2.Query",
	...
	Metadata: "merlin/gamm/v2/query.proto",
}
