...
func (s *QueryTestSuite) TestQueriesNeverAlterState() {
	...
	testCases := []struct {
		...
		{
			"Query estimate for join pool shares with no swap",
			"/merlin.gamm.v1beta1.Query/CalcJoinPoolShares",
		...
		},
		{
			...
			"/merlin.gamm.v1beta1.Query/CalcExitPoolCoinsFromShares",
