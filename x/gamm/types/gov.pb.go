...
// source: merlin/gamm/v1beta1/gov.proto
...
func init() {
	proto.RegisterType((*ReplaceMigrationRecordsProposal)(nil), "merlin.gamm.v1beta1.ReplaceMigrationRecordsProposal")
	proto.RegisterType((*UpdateMigrationRecordsProposal)(nil), "merlin.gamm.v1beta1.UpdateMigrationRecordsProposal")
}

func init() { proto.RegisterFile("merlin/gamm/v1beta1/gov.proto", fileDescriptor_f31b9a6c0dbbdfa3) }
