...
// source: merlin/incentives/gauge.proto
...
func init() {
	proto.RegisterType((*Gauge)(nil), "merlin.incentives.Gauge")
	proto.RegisterType((*LockableDurationsInfo)(nil), "merlin.incentives.LockableDurationsInfo")
}

func init() { proto.RegisterFile("merlin/incentives/gauge.proto", fileDescriptor_c0304e2bb0159901) }
