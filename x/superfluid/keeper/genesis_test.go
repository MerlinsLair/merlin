...
import (
	...
	simapp "github.com/merlinslair/merlin/app"
...
var testGenesis = types.GenesisState{
	...
	IntermediaryAccounts: []types.SuperfluidIntermediaryAccount{
		{
			Denom:   "gamm/pool/1",
			ValAddr: "mervaloper1cyw4vw20el8e7ez8080md0r8psg25n0cq98a9n",
			GaugeId: 1,
		},
	},
	IntemediaryAccountConnections: []types.LockIdIntermediaryAccountConnection{
		{
			LockId:              1,
			IntermediaryAccount: "mer1hpgapnfl3thkevvl0jp3wqtk8jw7mpqumuuc2f",
		},
	},
}
...
func TestInitGenesis(t *testing.T) {
	...
	multipliers := app.SuperfluidKeeper.GetAllMerEquivalentMultipliers(ctx)
	require.Equal(t, multipliers, genesis.MerEquivalentMultipliers)
...
func TestExportGenesis(t *testing.T) {
	...
	require.Equal(t, genesis.MerEquivalentMultipliers, genesis.MerEquivalentMultipliers)
