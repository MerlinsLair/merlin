...
import (
	...
	"github.com/merlinslair/merlin/x/poolmanager/client/cli"
	"github.com/merlinslair/merlin/x/poolmanager/client/queryproto"
	poolmanagertestutil "github.com/merlinslair/merlin/x/poolmanager/client/testutil"
...
// 	}{
// 		{
// 			"query pool estimate swap exact amount in", // merlind query poolmanager estimate-swap-exact-amount-in 1 cosmos1n8skk06h3kyh550ad9qketlfhc2l5dsdevd3hq 10.0stake --swap-route-pool-ids=1 --swap-route-denoms=node0token
// 			[]string{
// 				"1",
	...
	testCases := []struct {
		...
		},
		{
			...
			fmt.Sprintf(`
			{
			  ...
			  "%s": "0.001",
			  "%s": "0.001",
			  "%s": "mer1fqlr98d45v5ysqgp6h56kpujcj4cvsjnjq9nck"
			}
