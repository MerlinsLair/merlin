...
// source: merlin/poolmanager/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgSwapExactAmountIn)(nil), "merlin.poolmanager.v1beta1.MsgSwapExactAmountIn")
	proto.RegisterType((*MsgSwapExactAmountInResponse)(nil), "merlin.poolmanager.v1beta1.MsgSwapExactAmountInResponse")
	proto.RegisterType((*MsgSwapExactAmountOut)(nil), "merlin.poolmanager.v1beta1.MsgSwapExactAmountOut")
	proto.RegisterType((*MsgSwapExactAmountOutResponse)(nil), "merlin.poolmanager.v1beta1.MsgSwapExactAmountOutResponse")
}

func init() {
	proto.RegisterFile("merlin/poolmanager/v1beta1/tx.proto", fileDescriptor_acd130b4825d67dc)
}
...
var fileDescriptor_acd130b4825d67dc = []byte{
	...
	0xec, 0x2e, 0x89, 0x82, 0xd8, 0x3b, 0x23, 0x82, 0x81, 0x2e, 0xd1, 0xf5, 0xce, 0x9b, 0x30, 0x49,
	...
	0xff, 0xff, 0x3f, 0x5f, 0x74, 0xdb, 0x03, 0x06, 0x00, 0x00,
}
...
func (c *msgClient) SwapExactAmountIn(ctx context.Context, in *MsgSwapExactAmountIn, opts ...grpc.CallOption) (*MsgSwapExactAmountInResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlin.poolmanager.v1beta1.Msg/SwapExactAmountIn", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SwapExactAmountOut(ctx context.Context, in *MsgSwapExactAmountOut, opts ...grpc.CallOption) (*MsgSwapExactAmountOutResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlin.poolmanager.v1beta1.Msg/SwapExactAmountOut", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SwapExactAmountIn_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlin.poolmanager.v1beta1.Msg/SwapExactAmountIn",
	}
...
func _Msg_SwapExactAmountOut_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlin.poolmanager.v1beta1.Msg/SwapExactAmountOut",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "merlin.poolmanager.v1beta1.Msg",
	...
	Metadata: "merlin/poolmanager/v1beta1/tx.proto",
}
