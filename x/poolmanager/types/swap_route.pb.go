...
// source: merlin/poolmanager/v1beta1/swap_route.proto
...
func init() {
	proto.RegisterType((*SwapAmountInRoute)(nil), "merlin.poolmanager.v1beta1.SwapAmountInRoute")
	proto.RegisterType((*SwapAmountOutRoute)(nil), "merlin.poolmanager.v1beta1.SwapAmountOutRoute")
}

func init() {
	proto.RegisterFile("merlin/poolmanager/v1beta1/swap_route.proto", fileDescriptor_cddd97a9a05492a8)
}
...
var fileDescriptor_cddd97a9a05492a8 = []byte{
	...
	0x49, 0xc5, 0x30, 0x8e, 0x7e, 0x99, 0xa1, 0x89, 0x7e, 0x05, 0x4a, 0x2c, 0x95, 0x54, 0x16, 0xa4,
	0x16, 0x27, 0xb1, 0x81, 0x83, 0xd9, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0x08, 0xd8, 0x55, 0x31,
	0xc9, 0x01, 0x00, 0x00,
}
