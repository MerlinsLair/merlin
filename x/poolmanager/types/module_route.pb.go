...
// source: merlin/poolmanager/v1beta1/module_route.proto
...
type ModuleRoute struct {
	...
	PoolType PoolType `protobuf:"varint,1,opt,name=pool_type,json=poolType,proto3,enum=merlin.poolmanager.v1beta1.PoolType" json:"pool_type,omitempty"`
}
...
func init() {
	proto.RegisterEnum("merlin.poolmanager.v1beta1.PoolType", PoolType_name, PoolType_value)
	proto.RegisterType((*ModuleRoute)(nil), "merlin.poolmanager.v1beta1.ModuleRoute")
}

func init() {
	proto.RegisterFile("merlin/poolmanager/v1beta1/module_route.proto", fileDescriptor_96bfcc7b6d387cee)
}
...
var fileDescriptor_96bfcc7b6d387cee = []byte{
	...
	0x4d, 0xf4, 0x2b, 0x50, 0xc2, 0x0b, 0xe4, 0x95, 0xe2, 0x24, 0x36, 0xb0, 0x77, 0x8d, 0x01, 0x01,
	0x00, 0x00, 0xff, 0xff, 0xf2, 0x18, 0x27, 0x5d, 0x53, 0x01, 0x00, 0x00,
}
