...
// source: merlin/txfees/v1beta1/gov.proto
...
func init() {
	proto.RegisterType((*UpdateFeeTokenProposal)(nil), "merlin.txfees.v1beta1.UpdateFeeTokenProposal")
}

func init() { proto.RegisterFile("merlin/txfees/v1beta1/gov.proto", fileDescriptor_2c4a51bafc82863d) }
