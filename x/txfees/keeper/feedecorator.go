...
import (
	...
	"github.com/merlinslair/merlin/x/txfees/keeper/txfee_filters"
...
func (mfd MempoolFeeDecorator) AnteHandle(ctx sdk.Context, tx sdk.Tx, simulate bool, next sdk.AnteHandler) (newCtx sdk.Context, err error) {
	...
	// converting every non-mer specified asset into an mer-equivalent amount, to determine sufficiency.
