...
func TestDeconstructDenom(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{
			desc:             "normal",
			denom:            "factory/mer1t7egva48prqmzl59x5ngv4zx0dtrwewc9m7z44/bitcoin",
			expectedSubdenom: "bitcoin",
		},
		{
			desc:             "multiple slashes in subdenom",
			denom:            "factory/mer1t7egva48prqmzl59x5ngv4zx0dtrwewc9m7z44/bitcoin/1",
			expectedSubdenom: "bitcoin/1",
		},
		{
			desc:             "no subdenom",
			denom:            "factory/mer1t7egva48prqmzl59x5ngv4zx0dtrwewc9m7z44/",
			expectedSubdenom: "",
		},
		{
			desc:  "incorrect prefix",
			denom: "ibc/mer1t7egva48prqmzl59x5ngv4zx0dtrwewc9m7z44/bitcoin",
			err:   types.ErrInvalidDenom,
		},
		{
		...
		{
			desc:  "too long name",
			denom: "factory/mer1t7egva48prqmzl59x5ngv4zx0dtrwewc9m7z44/adsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsf",
			err:   types.ErrInvalidDenom,
		},
	} {
		t.Run(tc.desc, func(t *testing.T) {
			expectedCreator := "mer1t7egva48prqmzl59x5ngv4zx0dtrwewc9m7z44"
...
func TestGetTokenDenom(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{
			desc:     "normal",
			creator:  "mer1t7egva48prqmzl59x5ngv4zx0dtrwewc9m7z44",
			subdenom: "bitcoin",
			valid:    true,
		},
		{
		...
		},
		{
			...
			creator:  "mer1t7egva48prqmzl59x5ngv4zx0dtrwewc9m7z44jhgjhgkhjklhkjhkjhgjhgjgjghelugt",
			subdenom: "bitcoin",
			valid:    true,
		},
	} {
