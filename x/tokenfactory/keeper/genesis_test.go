...
func (suite *KeeperTestSuite) TestGenesis() {
		...
		FactoryDenoms: []types.GenesisDenom{
			{
				...
				AuthorityMetadata: types.DenomAuthorityMetadata{
					Admin: "mer1t7egva48prqmzl59x5ngv4zx0dtrwewc9m7z44",
				},
			},
			{
				Denom: "factory/mer1t7egva48prqmzl59x5ngv4zx0dtrwewc9m7z44/diff-admin",
				AuthorityMetadata: types.DenomAuthorityMetadata{
					Admin: "mer15czt5nhlnvayqq37xun9s9yus0d6y26dw9xnzn",
				},
			},
			{
				Denom: "factory/mer1t7egva48prqmzl59x5ngv4zx0dtrwewc9m7z44/litecoin",
				AuthorityMetadata: types.DenomAuthorityMetadata{
					Admin: "mer1t7egva48prqmzl59x5ngv4zx0dtrwewc9m7z44",
				},
			},
	...
	app.TokenFactoryKeeper.SetParams(suite.Ctx, types.Params{DenomCreationFee: sdk.Coins{sdk.NewInt64Coin("umer", 100)}})
