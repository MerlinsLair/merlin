...
// source: merlin/concentrated-liquidity/tickInfo.proto
...
func init() {
	proto.RegisterType((*TickInfo)(nil), "merlin.concentratedliquidity.v1beta1.TickInfo")
}

func init() {
	proto.RegisterFile("merlin/concentrated-liquidity/tickInfo.proto", fileDescriptor_1ccb7e45032b943a)
}
