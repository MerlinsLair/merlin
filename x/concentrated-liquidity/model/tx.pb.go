...
// source: merlin/concentrated-liquidity/pool-model/tx.proto
...
func init() {
	proto.RegisterType((*MsgCreateConcentratedPool)(nil), "merlin.concentratedliquidity.v1beta1.MsgCreateConcentratedPool")
	proto.RegisterType((*MsgCreateConcentratedPoolResponse)(nil), "merlin.concentratedliquidity.v1beta1.MsgCreateConcentratedPoolResponse")
}

func init() {
	proto.RegisterFile("merlin/concentrated-liquidity/pool-model/tx.proto", fileDescriptor_6c324e8c9dd2851d)
}
...
func (c *msgCreatorClient) CreateConcentratedPool(ctx context.Context, in *MsgCreateConcentratedPool, opts ...grpc.CallOption) (*MsgCreateConcentratedPoolResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlin.concentratedliquidity.v1beta1.MsgCreator/CreateConcentratedPool", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MsgCreator_CreateConcentratedPool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlin.concentratedliquidity.v1beta1.MsgCreator/CreateConcentratedPool",
	}
...
var _MsgCreator_serviceDesc = grpc.ServiceDesc{
	ServiceName: "merlin.concentratedliquidity.v1beta1.MsgCreator",
	...
	Metadata: "merlin/concentrated-liquidity/pool-model/tx.proto",
}
