...
// source: merlin/concentrated-liquidity/pool.proto
...
func init() {
	proto.RegisterType((*Pool)(nil), "merlin.concentratedliquidity.v1beta1.Pool")
}

func init() {
	proto.RegisterFile("merlin/concentrated-liquidity/pool.proto", fileDescriptor_3526ea5373d96c9a)
}
