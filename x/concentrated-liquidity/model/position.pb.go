...
// source: merlin/concentrated-liquidity/position.proto
...
func init() {
	proto.RegisterType((*Position)(nil), "merlin.concentratedliquidity.v1beta1.Position")
}

func init() {
	proto.RegisterFile("merlin/concentrated-liquidity/position.proto", fileDescriptor_ffdfd7b30d37d326)
}
