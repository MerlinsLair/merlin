...
import (
	...
	clmodule "github.com/merlinslair/merlin/x/concentrated-liquidity/clmodule"
...
func init() {
	pool1, err := model.NewConcentratedLiquidityPool(1, "umer", "uatom", 5, sdk.NewInt(-4), DefaultZeroSwapFee)
	if err != nil {
		panic(err)
	}
