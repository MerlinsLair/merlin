...
import (
	...
	clkeeper "github.com/merlinslair/merlin/x/concentrated-liquidity"
	clmodeltypes "github.com/merlinslair/merlin/x/concentrated-liquidity/model"
...
func RandomMsgCreateConcentratedPool(k clkeeper.Keeper, sim *mersimtypes.SimCtx, ctx sdk.Context) (*clmodeltypes.MsgCreateConcentratedPool, error) {
...
func createPoolRestriction(k clkeeper.Keeper, sim *mersimtypes.SimCtx, ctx sdk.Context) mersimtypes.SimAccountConstraint {
