	...
	cases := []struct {
	...
	}{
		{
			...
			expected: [][]TestRoute{
				...
				{
					{PoolId: 25, InputDenom: types.MerlinDenomination, OutputDenom: types.AtomDenomination},
					{PoolId: 1, InputDenom: types.AtomDenomination, OutputDenom: "akash"},
					{PoolId: 7, InputDenom: "akash", OutputDenom: types.MerlinDenomination},
				},
			},
			...
			expected: [][]TestRoute{
				{
					...
					{PoolId: 10, InputDenom: "bitcoin", OutputDenom: types.MerlinDenomination},
				},
			},
		...
		},
		{
			...
			expected: [][]TestRoute{
				{
					{PoolId: 9, InputDenom: types.MerlinDenomination, OutputDenom: "ethereum"},
		...
		},
		{
			...
			inputDenom:  "usdc",
			outputDenom: types.MerlinDenomination,
			poolID:      29,
			expected: [][]TestRoute{
				{
					{PoolId: 29, InputDenom: types.MerlinDenomination, OutputDenom: "usdc"},
					{PoolId: 34, InputDenom: "usdc", OutputDenom: "busd"},
					{PoolId: 30, InputDenom: "busd", OutputDenom: types.MerlinDenomination},
				},
			},
		...
		{
			description: "Two routes exist but only 1 route left to be explored (mer route chosen)",
			inputDenom:  "bitcoin",
			outputDenom: "ethereum",
			poolID:      19,
			expected: [][]TestRoute{
...
func (suite *KeeperTestSuite) TestBuildHighestLiquidityRoute() {
	cases := []struct {
	...
	}{
		{
			...
			swapDenom:          types.MerlinDenomination,
			swapIn:             types.AtomDenomination,
			swapOut:            "akash",
			poolId:             1,
			expectedRoute:      []TestRoute{{7, types.MerlinDenomination, "akash"}, {1, "akash", types.AtomDenomination}, {25, types.AtomDenomination, types.MerlinDenomination}},
			hasRoute:           true,
			expectedPointCount: 6,
		},
		{
			...
			poolId:             1,
			expectedRoute:      []TestRoute{{25, types.MerlinDenomination, types.AtomDenomination}, {1, types.AtomDenomination, "akash"}, {7, "akash", types.MerlinDenomination}},
			hasRoute:           true,
			expectedPointCount: 6,
		},
		{
		...
		},
		{
			...
			swapOut:            "akash",
			poolId:             7,
			expectedRoute:      []TestRoute{{1, types.AtomDenomination, "akash"}, {7, "akash", types.MerlinDenomination}, {25, types.MerlinDenomination, types.AtomDenomination}},
			hasRoute:           true,
			expectedPointCount: 6,
		},
		{
			...
			poolId:             7,
			expectedRoute:      []TestRoute{{25, types.AtomDenomination, types.MerlinDenomination}, {7, types.MerlinDenomination, "akash"}, {1, "akash", types.AtomDenomination}},
			hasRoute:           true,
			expectedPointCount: 6,
		},
		{
