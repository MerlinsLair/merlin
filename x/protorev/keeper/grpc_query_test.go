...
func (suite *KeeperTestSuite) TestGetProtoRevNumberOfTrades() {
	...
	err = suite.App.AppKeepers.ProtoRevKeeper.UpdateStatistics(suite.Ctx, poolmanagertypes.SwapAmountInRoutes{}, types.MerlinDenomination, sdk.NewInt(10000))
	suite.Require().NoError(err)
...
func (suite *KeeperTestSuite) TestGetProtoRevProfitsByDenom() {
	req := &types.QueryGetProtoRevProfitsByDenomRequest{
		Denom: types.MerlinDenomination,
	}
	...
	err = suite.App.AppKeepers.ProtoRevKeeper.UpdateStatistics(suite.Ctx, poolmanagertypes.SwapAmountInRoutes{}, types.AtomDenomination, sdk.NewInt(10000))
	...
	suite.Require().NoError(err)
	suite.Require().Equal(sdk.NewInt(10000), res.Profit.Amount)
	suite.Require().Equal(types.AtomDenomination, res.Profit.Denom)
}
...
func (suite *KeeperTestSuite) TestGetProtoRevAllProfits() {
	...
	// Pseudo execute a trade
	err = suite.App.AppKeepers.ProtoRevKeeper.UpdateStatistics(suite.Ctx, poolmanagertypes.SwapAmountInRoutes{}, types.MerlinDenomination, sdk.NewInt(9000))
	suite.Require().NoError(err)
	...
	suite.Require().Contains(res.Profits, &mer)
	...
	res, err = suite.queryClient.GetProtoRevAllProfits(sdk.WrapSDKContext(suite.Ctx), req)
	suite.Require().NoError(err)
	atom = sdk.NewCoin(types.AtomDenomination, sdk.NewInt(13000))
...
func (suite *KeeperTestSuite) TestGetProtoRevStatisticsByRoute() {
	...
	coin := sdk.NewCoin(types.AtomDenomination, sdk.NewInt(10000))
	...
	coin = sdk.NewCoin(types.AtomDenomination, sdk.NewInt(90000))
	suite.Require().Contains(res.Statistics.Profits, &coin)

	// Pseudo execute another trade in a different denom (might happen in multidenom pools > 2 denoms)
	err = suite.App.AppKeepers.ProtoRevKeeper.UpdateStatistics(suite.Ctx, poolmanagertypes.SwapAmountInRoutes{{TokenOutDenom: "", PoolId: 1}, {TokenOutDenom: "", PoolId: 2}, {TokenOutDenom: "", PoolId: 3}}, types.MerlinDenomination, sdk.NewInt(80000))
	suite.Require().NoError(err)
...
func (suite *KeeperTestSuite) TestGetProtoRevAllRouteStatistics() {
	...
	// Pseudo execute a trade
	err = suite.App.AppKeepers.ProtoRevKeeper.UpdateStatistics(suite.Ctx, poolmanagertypes.SwapAmountInRoutes{{TokenOutDenom: "", PoolId: 1}, {TokenOutDenom: "", PoolId: 2}, {TokenOutDenom: "", PoolId: 3}}, types.MerlinDenomination, sdk.NewInt(10000))
	suite.Require().NoError(err)
	...
	suite.Require().Contains(res.Statistics[0].Profits, &merCoin)
	...
	err = suite.App.AppKeepers.ProtoRevKeeper.UpdateStatistics(suite.Ctx, poolmanagertypes.SwapAmountInRoutes{{TokenOutDenom: "", PoolId: 1}, {TokenOutDenom: "", PoolId: 2}, {TokenOutDenom: "", PoolId: 4}}, types.MerlinDenomination, sdk.NewInt(70000))
	suite.Require().NoError(err)
	...
	suite.Require().Contains(res.Statistics[1].Profits, &merCoin)
	...
	atomCoin := sdk.NewCoin(types.AtomDenomination, sdk.NewInt(80000))
