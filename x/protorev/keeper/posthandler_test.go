...
import (
	...
	"github.com/merlinslair/merlin/x/protorev/keeper"
	...
	tests := []struct {
		...
		},
		{
			...
			params: param{
				...
				txFee:               sdk.NewCoins(sdk.NewCoin(types.MerlinDenomination, sdk.NewInt(10000))),
				minGasPrices:        sdk.NewDecCoins(),
				gasLimit:            500000,
				isCheckTx:           false,
				baseDenomGas:        true,
				...
				msgs: []sdk.Msg{
					&poolmanagertypes.MsgSwapExactAmountIn{
						...
						Routes: []poolmanagertypes.SwapAmountInRoute{
							{
								PoolId:        29,
								TokenOutDenom: types.MerlinDenomination,
							},
						},
			...
			params: param{
				msgs: []sdk.Msg{
					...
					&poolmanagertypes.MsgSwapExactAmountIn{
						...
						TokenIn:           sdk.NewCoin("umer", sdk.NewInt(10000)),
						TokenOutMinAmount: sdk.NewInt(10000),
					},
				},
				txFee:              sdk.NewCoins(sdk.NewCoin("umer", sdk.NewInt(10000))),
