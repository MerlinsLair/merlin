...
// source: merlin/protorev/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "merlin.protorev.v1beta1.GenesisState")
}

func init() {
	proto.RegisterFile("merlin/protorev/v1beta1/genesis.proto", fileDescriptor_3c77fc2da5752af2)
}
