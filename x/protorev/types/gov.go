...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(&SetProtoRevEnabledProposal{}, "merlin/SetProtoRevEnabledProposal")
	govtypes.RegisterProposalType(ProposalTypeSetProtoRevAdminAccount)
	govtypes.RegisterProposalTypeCodec(&SetProtoRevAdminAccountProposal{}, "merlin/SetProtoRevAdminAccountProposal")
}
