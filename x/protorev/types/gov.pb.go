...
// source: merlin/protorev/v1beta1/gov.proto
...
func init() {
	proto.RegisterType((*SetProtoRevEnabledProposal)(nil), "merlin.protorev.v1beta1.SetProtoRevEnabledProposal")
	proto.RegisterType((*SetProtoRevAdminAccountProposal)(nil), "merlin.protorev.v1beta1.SetProtoRevAdminAccountProposal")
}

func init() {
	proto.RegisterFile("merlin/protorev/v1beta1/gov.proto", fileDescriptor_e1f85ff7f3eaf8bb)
}
