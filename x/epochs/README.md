...
On Merlin mainnet, we only utilize one identifier, with a time interval of `one day`.
...
The Epochs module keeps a single [`EpochInfo`](https://github.com/merlinslair/merlin/blob/b4befe4f3eb97ebb477323234b910c4afafab9b7/proto/merlin/epochs/genesis.proto#L12) per identifier.
