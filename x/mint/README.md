...
validators, incentivize providing pool liquidity, provide funds for Merlin governance,
and pay developers to maintain and improve Merlin.
...
tokens within a chain. The design taken within Merlin is to
...
The [`Minter`](https://github.com/merlinslair/merlin/blob/cbb683e8395655042b4421355cd54a8c96bfa507/x/mint/types/mint.pb.go#L30) is an abstraction for holding current rewards information.
...
Minting [`Params`](https://github.com/merlinslair/merlin/blob/cbb683e8395655042b4421355cd54a8c96bfa507/x/mint/types/mint.pb.go#L168) are held in the global params store.
...
| weighted_developer_rewards_receivers       | array        | [{"address": "merxx", "weight": "1"}] |
...
1. `mint_denom` defines denom for minting token - umer
...
```bash
merlind query mint params -o json | jq
```
...
```bash
merlind query mint epoch-provisions
```
