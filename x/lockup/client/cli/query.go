...
func GetCmdAccountLockedDuration() *cobra.Command {
	return osmocli.SimpleQueryCmd[*types.AccountLockedDurationRequest](
		...
		`{{.Short}}{{.ExampleHeader}}
{{.CommandPrefix}} account-locked-duration mer1yl6hdjhmkf37639730gffanpzndzdpmhxy9ep3 604800s`, types.ModuleName, types.NewQueryClient)
}
...
{{.CommandPrefix}} total-locked-of-denom umer --min-duration=0s`, types.ModuleName),
