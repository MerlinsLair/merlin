...
#Add public servers to spec file for Merlin testnet and mainnet
yq -i '."servers"+=[{"url":"https://lcd.merlin.zone","description":"Merlin mainnet node"},{"url":"https://lcd-test.merlin.zone","description":"Merlin testnet node"}]' static/openapi/openapi.yaml
