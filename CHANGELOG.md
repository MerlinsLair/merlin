...
* [#3899](https://github.com/merlinslair/merlin/pull/3899) Fixed osmoutils so its importable by chains that don't use the merlin CosmosSDK fork 
...
## [v7.1.0](https://github.com/merlinslair/merlin/releases/tag/v7.1.0)
...
* [sdk-#161](https://github.com/osmosis-labs/cosmos-sdk/pull/155) upgrade iavl to v0.17.3-mer-v7 with lowered fast node cache size
...
* [sdk-#135](https://github.com/osmosis-labs/cosmos-sdk/pull/135) upgrade iavl to v0.17.3-mer-v5 with concurrent map write fix
...
* [sdk-#108](https://github.com/osmosis-labs/cosmos-sdk/pull/108) upgrade to IAVL fast storage on v0.45.0x-mer-v7-fast
