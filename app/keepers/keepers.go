...
import (
	...
	downtimedetector "github.com/merlinslair/merlin/x/downtime-detector"
	downtimetypes "github.com/merlinslair/merlin/x/downtime-detector/types"
	"github.com/merlinslair/merlin/x/gamm"
	ibcratelimit "github.com/merlinslair/merlin/x/ibc-rate-limit"
	...
	owasm "github.com/merlinslair/merlin/wasmbinding"
	concentratedliquidity "github.com/merlinslair/merlin/x/concentrated-liquidity"
	concentratedliquiditytypes "github.com/merlinslair/merlin/x/concentrated-liquidity/types"
	epochskeeper "github.com/merlinslair/merlin/x/epochs/keeper"
	...
	incentiveskeeper "github.com/merlinslair/merlin/x/incentives/keeper"
	incentivestypes "github.com/merlinslair/merlin/x/incentives/types"
	lockupkeeper "github.com/merlinslair/merlin/x/lockup/keeper"
	lockuptypes "github.com/merlinslair/merlin/x/lockup/types"
	mintkeeper "github.com/merlinslair/merlin/x/mint/keeper"
	...
	protorevkeeper "github.com/merlinslair/merlin/x/protorev/keeper"
	protorevtypes "github.com/merlinslair/merlin/x/protorev/types"
	"github.com/merlinslair/merlin/x/superfluid"
	superfluidkeeper "github.com/merlinslair/merlin/x/superfluid/keeper"
	superfluidtypes "github.com/merlinslair/merlin/x/superfluid/types"
	tokenfactorykeeper "github.com/merlinslair/merlin/x/tokenfactory/keeper"
	...
	txfeeskeeper "github.com/merlinslair/merlin/x/txfees/keeper"
	txfeestypes "github.com/merlinslair/merlin/x/txfees/types"
	valsetpref "github.com/merlinslair/merlin/x/valset-pref"
...
func (appKeepers *AppKeepers) InitNormalKeepers(
	...
	supportedFeatures := "iterator,staking,stargate,merlin,cosmwasm_1_1"
...
func (appKeepers *AppKeepers) WireICS20PreWasmKeeper(
	...
	merPrefix := sdk.GetConfig().GetBech32AccountAddrPrefix()
	wasmHooks := ibchooks.NewWasmHooks(hooksKeeper, nil, merPrefix) // The contract keeper needs to be set later
