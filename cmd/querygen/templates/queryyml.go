...
type QueryYml struct {
	...
	// Path to client folder e.g. "github.com/merlinslair/merlin/x/twap/client"
...
type Keeper struct {
	// e.g. github.com/merlinslair/merlin/x/twap
...
// input is of form github.com/merlinslair/merlin/vXX/{PATH}
// returns PATH
